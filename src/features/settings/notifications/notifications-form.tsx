    ...
    <Form {...form}>
      ...
      >
        ...
        <div className='relative'>
          <h3 className='mb-4 text-lg font-medium'>邮件通知提醒</h3>
          <div className='space-y-4'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    <FormLabel className='text-base'>社交活动邮件</FormLabel>
                    <FormDescription>
                      接收关于好友申请、被关注及评论互动的邮件。
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    <FormLabel className='text-base'>账户安全邮件</FormLabel>
                    <FormDescription>
                      接收关于您账户安全变动、异常登录等系统关键事件的邮件。
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch

    ...
    <div className='space-y-4'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>周点击量与独立访客趋势</CardDescription>
        </CardHeader>
      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>网页跳出率</CardTitle>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
              fill='none'
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>3分 24秒</div>
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        <Card className='col-span-1 lg:col-span-4'>
          <CardHeader>
            ...
            <CardDescription>驱动流量的前几大来源</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
        ...
        <Card className='col-span-1 lg:col-span-3'>
          <CardHeader>
            <CardTitle>访问设备占比</CardTitle>
            <CardDescription>用户用来访问的设备终端统计说明</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
